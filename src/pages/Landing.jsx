...
const Landing = () => {
  return (
    <div className="h-max absolute w-full text-black top-0 bg-slate-200">
      ...
      <div className='relative flex mt-96 px-[10%] flex-col gap-64 z-20'>
        <div className=" flex justify-between gap-32">
          <h1 
            className="text-white text-8xl font-bold w-4/6">
        ...
        {/* <div className='relative bottom-[-475px]'>
      ...
      <div className='flex flex-col'>
        <div className='flex gap-20 mt-[700px] px-[10%] my-44'>
          <span className='w-2/4'>
            <h1 className='p-5 pl-0 w-max border-t-2 text-4xl font-bold text-start border-blue-300'>About Us</h1>
          </span>
          <p className='w-2/4 text-2xl font-mazzard-bold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam porro molestias cupiditate aspernatur dicta expedita possimus ut alias dolor explicabo.</p>
        </div>
      </div>
      <Footer />
    </div>
